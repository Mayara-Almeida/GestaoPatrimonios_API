...
namespace GestaoPatrimonios.Applications.Services
{
    public class LocalizacaoService
    {
        ...
        public List<ListarLocalizacaoDto> Listar()
        {
            ...
            List<ListarLocalizacaoDto> localizacoesDtos = localizacoes.Select(localizacao => new ListarLocalizacaoDto
            {
        ...
        public void Adicionar (CriarLocalizacaoDto dto)
        {
            ...
            if(!_repository.AreaExiste(dto.AreaID)) // Se a área informada não existir
            {
